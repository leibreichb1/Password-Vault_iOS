...
@implementation PVOptionsViewController
...
- (void)viewDidLoad
{
	...
	selectionsArray = [[NSArray alloc] initWithObjects:@"contacts", @"tracking", @"locations", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [selectionsArray objectAtIndex:indexPath.row];
    return cell;
}
...
{
    if([[selectionsArray objectAtIndex:indexPath.row] isEqualToString:@"contacts"]){
